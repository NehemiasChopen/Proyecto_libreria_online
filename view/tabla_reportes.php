...
<body>
    ...
    <div id="main-container">
        ...
        <h1 class="text-center p-3">TABLA DE REPORTES</h1>
        ...
        <div class="container-lg">
            <table class="table table-dark table-hover">
                ...
                <tbody>
                    ...
                    echo "<tr>";
                    echo "<td>".$dato["id_aten"]."</td>";
                    echo "<td>".$dato["nombre"]."</td>";
                    echo "<td>".$dato["correo"]."</td>";
                    echo "<td>".$dato["telefono"]."</td>";
                    echo "<td>".$dato["motivo_mensaje"]."</td>";
                    echo "<td>".$dato["detalles"]."</td>";
                    echo "<td>".$dato["estado"]."</td>";
              ?>
                    <td>
                        <!-- Boton para modifcar los datos-->
                        <a href="../controller/modificar_reporte.php?id=<?= $dato["id_aten"] ?>"
                            class="btn btn-small btn-warning"><i class="fa-solid fa-headset fa-xl"></i></a>
