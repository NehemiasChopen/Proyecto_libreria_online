...
<body>
    ...
    <div id="main-container">
        <h1 class="text-center p-3">TABLA DE MARCAS</h1>

        <p></p>
        <div class="container-lg">
            <a href="../view/agregar_marca.php" class="btn btn-small btn-success"><i
            ...
            foreach($r as $dato){//mostrar los datos de la BD
                    ...
                    <td>
                        ...
                        <a href="../controller/modificar_marca.php?id=<?= $dato["id_marc"] ?>"
                            class="btn btn-small btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
                        <!-- Boton para eliminar los datos -->
                        <a href="../controller/eliminar_marca.php?id=<?= $dato["id_marc"] ?>"
